...
open class RiffsyModule {
  @Provides @PerActivity open fun provideRiffsyApi(builder: Retrofit.Builder): RiffsyApiClient {
    return builder.baseUrl(RiffsyApiClient.BASE_URL).build().create(RiffsyApiClient::class.java)
  }
}
