...
public final class BaseAdapterTest extends RoboTestBase {
  ...
  public static class TestAdapter extends BaseAdapter<String, TestAdapter.TestViewHolder> {
    @Override public TestViewHolder onCreateViewHolder(final ViewGroup viewGroup, final int i) {
      return null;
    }

    @Override public void onBindViewHolder(final TestViewHolder testViewHolder, final int i) {
      // nothing
    }
