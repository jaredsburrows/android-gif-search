...
class GifActivity : ComponentActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    activityBinding.recyclerView.apply {
      ...
      addRecyclerListener { holder ->
        ...
        GlideApp.with(this).clear(gifViewHolder.listItemBinding.gifImage)
  ...
  fun GifScreen() {
    ...
    Scaffold(
      ...
      topBar = { TheToolbar(scrollBehavior = scrollBehavior) },
  ...
  @Composable
  fun TheToolbar(scrollBehavior: TopAppBarScrollBehavior) {
      ...
      actions = {
        ...
        DropdownMenu(
          ...
          DropdownMenuItem(
            ...
            text = { Text(text = stringResource(R.string.menu_licenses),) }
          )
        }
      },
...
//        .verticalScroll(rememberScrollState()),
      ...
      Box(modifier = Modifier.verticalScroll(rememberScrollState()).padding(32.dp)) {
        Column {
          TheGifs()
        }
      }
  ...
  private fun updateList(newList: List<GifImageInfo>?) {
    if (newList == null) {
      Snackbar.make(activityBinding.root, getString(R.string.error_loading_list), LENGTH_SHORT).show()
    } else {
  ...
  private fun showImageDialog(imageInfoModel: GifImageInfo) {
    ...
    dialogBinding.gifDialogTitle.apply {
      ...
      setOnClickListener {
        ...
        Snackbar.make(activityBinding.root, getString(R.string.copied_to_clipboard), LENGTH_SHORT).show()
      }
    }
...
//      addRecyclerListener { holder ->
//        val gifViewHolder = holder as GifAdapter.ViewHolder
//        GlideApp.with(this).clear(gifViewHolder.activityBinding.gifImage)
//
//        Timber.i("addRecyclerListener")
//      }
//      addOnScrollListener(
